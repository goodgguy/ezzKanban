(function ($) {
    ...
    $.fn.boardMn = function (options) {
        ...
        function modelChecklist(idcheck, content, status) {
            ...
            <span style="font-size: 12px;font-weight: bold;word-break: break-all;">${content}</span></div>
        ...
        function modalMessage(image, username, content, create_date) {
            let str = `<li class="list-group-item" style="background: #f4f4f4">
                <div class="row">
                  ...
                  <div class="col-11">
                    <span style="font-size: 10px;font-weight: bold;">${username}</span>
                    <p style="font-size: 12px;margin-bottom:-6px;word-break: break-all;">${content}</p>
